...
private:
  ...
  SegmentDescriptor nullSegmentSelector; // The first descriptor in the GDT is
...
public:
  ...
  uint16_t
  CodeSegmentSelector(); // returns the address to the code segment selector
  uint16_t
  DataSegmentSelector(); // returns the address to the data segment selector
};
