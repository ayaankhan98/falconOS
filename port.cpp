...
void Port8Bit::write(uint8_t data_) {
  write8(portNumber, data_);
}
...
void Port16Bit::write(uint16_t data_) {
  write16(portNumber, data_);
}
...
void Port32Bit::write(uint32_t data_) {
  write32(portNumber, data_);
}
