...
namespace falconOS {
    namespace resources {
        namespace syscalls {
            class SystemCallHandler : public falconOS::hardware_interaction::InterruptHandler {
                public:
                SystemCallHandler(falconOS::hardware_interaction::InterruptManager *interruptManager,
